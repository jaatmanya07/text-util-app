...
export default function About(props) {
    ...
    let style ={
        ...
        backgroundColor: props.mode==='dark'? 'rgb(27 84 136)':'white'
    };

    return (
        <div className='container' style={{color: props.mode==='dark'? 'white': 'black', backgroundColor: props.mode==='dark'? 'rgb(16 37 53)':'white'}}>
                ...
                <div className="accordion-item">
                    <h2 className="accordion-header">
                        <button className="accordion-button collapsed" style={style} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <strong>Accordiong Item 3</strong>
                        </button>
                    </h2>
